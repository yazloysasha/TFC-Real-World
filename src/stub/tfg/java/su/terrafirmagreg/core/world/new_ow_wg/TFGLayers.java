...
public class TFGLayers {
  ...
  public static int LOWLANDS;
  public static int PLAINS;
  public static int LOW_CANYONS;
  public static int SALT_MARSH;
  ...
  public static int OCEANIC_MOUNTAINS;
  public static int VOLCANIC_MOUNTAINS;
  public static int VOLCANIC_OCEANIC_MOUNTAINS;
  public static int VOLCANIC_MOUNTAIN_LAKE;
  public static int VOLCANIC_OCEANIC_MOUNTAIN_LAKE;
  public static int LAKE;
  public static int MOUNTAIN_LAKE;
  public static int OLD_MOUNTAIN_LAKE;
  public static int OCEANIC_MOUNTAIN_LAKE;
  public static int PLATEAU_LAKE;
